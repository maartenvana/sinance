...
public partial class SourceTransactionsMigrateData : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Description = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true)
                    .Annotation("MySql:CharSet", "utf8mb4"),
                DestinationAccount = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true)
                    .Annotation("MySql:CharSet", "utf8mb4"),
        ...
        migrationBuilder.Sql(@"
                ...
                SELECT ID,AccountNumber,Amount,BankAccountId,Date,Description,DestinationAccount,Name,CategoryId,ID,UserId
